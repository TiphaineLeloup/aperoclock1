 ...
 */
final class Version20190803103440 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_3BAE0AA7F6D4B9EA');
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7F6D4B9EA FOREIGN KEY (app_group_id) REFERENCES app_group (id) ON DELETE SET NULL');
    }
}
